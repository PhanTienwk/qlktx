...
public class ThongTinTaiKhoan extends javax.swing.JPanel {
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txtViewTenDangNhap, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
    ...
    void showViewTaiKhoan(String tendangnhap) {
        ...
        if (kiemtra) {
            ...
            ThongTinSinhVienDangKy sv = new SinhVienDangKyDAO().getAllThongTinSVTheoTenDN(tendangnhap);
            txtViewHoTenSV.setText(sv.getTenSV());
            txtViewMaSoSV.setText(sv.getMaSV());
            if (sv.getGioiTinh().equals("Nam")) {
                txtViewGioiTinh.setText("Nam");
            ...
            txtViewEmailSV.setText(sv.getEmail());
            txtViewQueQuan.setText(sv.getQueQuan());
            txtViewMaPhongSV.setText("Chưa đăng ký");
            txtViewTenDangNhap.setText(sv.getTenDangNhap());
        }
