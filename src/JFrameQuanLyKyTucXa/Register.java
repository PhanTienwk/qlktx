...
public class Register extends javax.swing.JFrame {
    ...
    void AddThongTinSinhVienDangKy() {
        ...
        String sql = "insert into thongtinsinhviendangky (maSV, tenSV, CCCD, gioiTinh, ngaySinh, email, tenDangNhap, soDienThoai, queQuan, maLop)"
                + "values(?,?,?,?,?,?,?,?,?,?)";
        int row = 0;
