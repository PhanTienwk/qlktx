...
public class QuanLySinhVienDK extends javax.swing.JPanel {
    ...
    private void btnUpdateSVMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnUpdateSVMouseClicked
        ...
        } else if (selectedMaPhong == null || selectedMaPhong.equals("")) {
            JOptionPane.showMessageDialog(this, "Hiện tại không có phòng đủ! Vui lòng thêm phòng");
    ...
    private void LayThongTinSinhVienUp(int count) {
        ...
        email = sv.getEmail();
        maSV=sv.getMaSV();
        loaiphong = new SinhVienDangKyDAO().LayThongTinLoaiPhong(tendangnhap);
    }
